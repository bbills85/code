	...
	def run(self):
		...
		while len(data):
			...
			if data.strip() == 'quit':
				...
				print "Inside class while (len) before close: ", tcpSocket
				tcpSocket.close()
                                print "Inside class while (len) after close: ", tcpSocket
...
while True:
	...
	print "Once socket is created: ", tcpSocket
